                              ...
                              return (
                                  <>
                                      <TableRow key={row.org_name}>
                                          ...
                                          <TableCell><Button type="button" sx={{bgcolor: row.color, p: 2, width: '100%'}}></Button></TableCell>
                                          <TableCell><img src={config.url.API_URL + row.logo} width="100px"/></TableCell>
                                          <TableCell >
                                              <Button 
                                                  type="button" 
